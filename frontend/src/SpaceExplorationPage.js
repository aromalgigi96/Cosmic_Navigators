...
const backendURL = 'http://13.59.103.201:8080';
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (file.type.startsWith('video')) {
        ...
        if (data.video_id) {
          setAnnotatedUrl(`${backendURL}/stream_video/${data.video_id}`);
          ...
          <Col xs={12} md={10} lg={9}>
            <div className="explore-wrapper">
              ...
              <div className="custom-card upload-card">
                ...
                {statusMessage && (
                  <p className="status-message mt-3">{statusMessage}</p>
                )}
              </div>
              ...
              <div className="custom-card annotated-card">
                ...
                {annotatedUrl ? (
                  ...
                  {isVideo ? (
                    <img
                      src={annotatedUrl}
                      alt="Annotated Video Stream"
                      className="annotated-video-img"
                    />
                  ) : (
